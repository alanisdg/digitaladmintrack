...
return [
    ...
    */
    ...
    'custom' => [
        'origin_id' => [
            'required' => 'El campo locación origen es obligatorio',
        ],
        'location_id' => [
            'required' => 'El campo locación destino es obligatorio',
        ],
        'driver_id' => [
            'required' => 'El campo Chofer es obligatorio',
        ],
        'device_id' => [
        ...
        'end' => [
            'required' => 'El campo Fecha de llegada es obligatorio',
        ],
        'box_id' => [
