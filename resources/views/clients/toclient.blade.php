...
<div class="row mt30">
    ...
    <div class="col-md-6">
        ...
        <table class="table table-striped table-hover table-condensed">
            ...
            <tbody>
            @foreach($client->toclient as $location)
            <tr>
                <td>{{ $location->name }}</td>
                ...
                <td><a class="btn btn-primary btn-xs" href="/toclientlocation/{{ $location->id }}">Editar</a></td>
                <td><a class="btn btn-primary btn-xs" href="/toclient/delete/{{ $location->id }}">Eliminar</a></td>
            </tr>
            @endforeach
        </tbody>
    </table>
