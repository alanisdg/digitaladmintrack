...
<div class="right_col" role="main">
    ...
    <form class="form-horizontal form-label-left" action="/dashboard/devices/update" method="post">
        ...
        <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Detener Cobranza desde:  </span>
            </label>
            <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="date" id="last-name"  name="stop_from" value="{{ $device->stop_from }}"   class="form-control col-md-7 col-xs-12">
            </div>
        </div>
