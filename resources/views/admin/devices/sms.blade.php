...
<div class="right_col" role="main">
    <h1>Equipo {{ $device->name }}</h1>
        ...
        {!! csrf_field() !!}
            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Codigo !R3,44,20
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                ...
                <input type="hidden" id="first-name"value="!R3,44,20" name="code" required="required" class="form-control col-md-7 col-xs-12">
