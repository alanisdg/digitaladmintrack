...
<body style="    background-color: #f3f0f0;">
    ...
    margin: 40px auto;"  > 
		<img src="http://digitaladmintrack.com/images/logodat.png" alt="logo" width="120">
			...
			<p style="color:#7cb2fb">Este correo es un recordatorio del pago que esta próximo a vencer el día {{ $clientDay }}/{{ $month }}/{{ $year }}</p>
			<p style="color:#7cb2fb">Su cuenta tiene un saldo pendiente de ${{ $deuda }}</p>
